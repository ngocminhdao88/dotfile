" symlink this file to c:\users\minh/.config/nvim/
" create another folder (autoload, plugged and snippets) in to c:\users\minh/.config/nvim/
set nocompatible " get rid of Vi compatibility mode

let g:python_host_prog = 'c:\users\minh\Anaconda3\envs\py2\python.exe'
let g:python3_host_prog = 'c:\users\minh\Anaconda3\python.exe'

execute pathogen#infect('c:\users\minh\AppData\Local\nvim\bundle\{}')
